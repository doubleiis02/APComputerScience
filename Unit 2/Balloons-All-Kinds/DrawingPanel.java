  ...
  implements MouseListener, MouseMotionListener, KeyListener
{
  ...
  public void addBalloon(int shape)
  {
    ...
    switch (shape)
    {
      ...
      case 4: activeBalloon = new RectangleBalloon(w/2, h/2, radius, color); break;
      case 5: activeBalloon = new FancyBalloon(w/2, h/2, radius, color); break;
      case 6: activeBalloon = new PartyBalloon(w/2, h/2, radius, color); break;
      case 7: activeBalloon = new SmileyBalloon(w/2, h/2, radius, color); break;
      case 8: activeBalloon = new BirthdayBalloon(w/2, h/2, radius, color); break;
